...
from providers import clear_prompt_asset_cache, load_runtime_prompt_context
from providers.prompt_assets import PromptAssetError, PromptAssetManager
...
def test_prompt_asset_manager_invalidates_cache_when_files_change(tmp_path: Path) -> None:
    ...
    manager = PromptAssetManager(root=root)
